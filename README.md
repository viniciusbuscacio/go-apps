...
| [go-design](https://github.com/viniciusbuscacio/go-design) | The design source of truth: icon rules (Fluent first, Lucide fallback), color tokens, typography, identity tiles and every vendored SVG — with a [browsable preview](https://viniciusbuscacio.github.io/go-design/). No product code; apps copy what they need. |
